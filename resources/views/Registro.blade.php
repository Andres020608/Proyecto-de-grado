    ...
    <header>
        ...
        <nav id="nav"> <!-- Barra de navegación -->
            <ul>
                ...
                <li><a href="{{ route('IniciarSesion') }}" id="registrate">Inicia Sesión</a></li> <!-- Se conecta con la pagina de inicio de sesion-->
            </ul>
        </nav>
    </header>
        ...
        <section class="contenedor-form">
            <div class="tarjeta-formulario">
                ...
                <form action="" method="post">
                    ...
                    <label for="text">Nombre completo</label> <!--1ra casilla-->
                ...
                <div class="grupo-formulario">
                    <label for="Repeatpassword">Repetir contraseña</label> <!--4ta casilla-->
                    <input type="Repeatpassword" id="Repeatpassword" name="Repeatpassword" required>
                </div>
                <button type="submit">Ingresar</button> <!--Boton para enviar-->
                <p class="register-text"> 
                    ¿Ya tienes cuenta? <a href="InicioSesion.html">Inicia Sesión</a> <!--Se conecta con la pagina de inicio de sesion-->
                </p>
            </form>
            </div>
        </section>
